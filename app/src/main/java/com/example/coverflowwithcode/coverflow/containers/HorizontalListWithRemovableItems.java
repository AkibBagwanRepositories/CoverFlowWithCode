package com.example.coverflowwithcode.coverflow.containers;
...
import com.example.coverflowwithcode.R;
import com.example.coverflowwithcode.coverflow.containers.interfaces.IRemovableItemsAdapterComponent;
import com.example.coverflowwithcode.coverflow.containers.interfaces.IRemoveFromAdapter;
import com.example.coverflowwithcode.coverflow.general.ToolBox;
...
public class HorizontalListWithRemovableItems extends HorizontalList {
	...
	private Drawable mRemoveItemIconDrawable = getResources().getDrawable(R.drawable.ic_launcher_background);
